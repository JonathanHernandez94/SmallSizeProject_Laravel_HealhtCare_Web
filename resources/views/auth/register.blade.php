<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone_number" class="block mt-1 w-full" type="tel" name="phone_number" :value="old('phone_number')" required placeholder="598########" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="document_photo" class="block mt-1 w-full" type="file" name="document_photo" required  />
